...
## Training
The model was trained for **1000 epochs** using Google Colab. A batch size of 52 was chosen in order to have batches of the same size, and to also be able to take advantage of vectorization speed-up.
